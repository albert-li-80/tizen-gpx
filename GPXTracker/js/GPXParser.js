function GPXParser(xmlDoc, map){
	...
	this.pointarrayinjson = [];
	this.elearray = [];
	this.distancearray = [];
	
	// Set the colour of the track line segements.
	GPXParser.prototype.getDistanceArray = function() {
	    return this.distancearray;
	}
	
	// Set the colour of the track line segements.
	GPXParser.prototype.getEleArray = function() {
	    return this.elearray;
	}

	// Set the colour of the track line segements.
	GPXParser.prototype.getPointArray = function() {
	    return this.pointarrayinjson;
	}
	...
	GPXParser.prototype.addTrackSegmentToMap = function(trackSegment, colour,
	    ...
	    this.pointarrayinjson.push(latlng.toJSON());
